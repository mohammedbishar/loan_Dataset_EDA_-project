...
with open('ScalerLGBMRegressor.pkl', 'rb') as f:
    scaler= pickle.load(f)

emp_map = {'Employed':0, 'Self-Employed':0, 'Unemployed':3}
edu_map = {'High School':0,'Associate':1,'Bachelor':2,'Master':3,'Doctorate':4}
features_to_log1p = ['LoanAmount','MonthlyIncome', 'NetWorth']
num_cols_to_standardize = ['Age', 'CreditScore', 'LoanAmount','LoanDuration', 
